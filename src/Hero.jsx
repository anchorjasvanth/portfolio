    ...
    >
      <div className="flex flex-col justify-center mx-auto lg:mr-[10%] mb-50 my-60 lg:my-50">
        ...
        <button
          ...
          className="rounded-4xl shadow-primary shadow-xl/30 p-5 mt-[10%] text-secondary-text bg-primary text-1xl xl:text-2xl 2xl:text-3xl font-extrabold cursor-pointer border-primary-text border-2"
        >
          BRING ME ON STAGE
        </button>
      </div>
