        ...
        <div className="flex flex-col justify-start gap-10 w-full">
          {contactInfo.map((item, index) => (
            ...
            >
              <div
                className={`
                    p-4 rounded-xl transition-all duration-300 transform bg-white animate-extend-right 
                    ${
                      hoveredItem === item.type
                        ? "scale-y-105 shadow-lg shadow-primary/20"
                        : " "
                    }
                  `}
              ...
              >
                <div className="flex items-center mx-auto gap-4">
                  <span
                    className={`
                        text-xl xl:text-3xl transition-transform duration-300 flex flex-col justify-center w-10 
